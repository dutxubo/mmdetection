...
at::Tensor deform_conv_jit_forward_cuda(at::Tensor input, at::Tensor weight,
                             at::Tensor offset, at::Tensor output,
                             at::Tensor columns, at::Tensor ones, int64_t kW,
                             ...
                             int64_t deformable_group)
{
  ...
  // 对于 jit trace 这种写法无效 ？？
  // output = output.copy_(output_buffer);
