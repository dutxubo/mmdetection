...
def multiclasskeypoint_nms(multi_bboxes,
                           multi_keypoints,
                   multi_scores,
                   score_thr,
                   nms_cfg,
    ...
    Args:
        ...
        multi_keypoints (Tensor): shape (n, 2*num_keypoints)
    ...
    Returns:
        tuple: (bboxes, keypoints, labels), tensors of shape (k, 5), shape (k, 2*num_keypoints) and (k, 1). Labels
            are 0-based.
    """
