...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        #self._swish = MemoryEfficientSwish() # ori
        self._swish = Swish()
    ...
    def get_list_features(self):
        ...
        #efficientnet-b1 : [16, 24, 40, 80, 112, 192, 320]
        #efficientnet-b2 : [16, 24, 48, 88, 120, 208, 352]
        #efficientnet-b3 : [24, 32, 48, 96, 136, 232, 384]
        #efficientnet-b4 : [24, 32, 56, 112, 160, 272, 448]
        #efficientnet-b5 : [24, 40, 64, 128, 176, 304, 512]
        #efficientnet-b6 : [32, 40, 72, 144, 200, 344, 576]
        #efficientnet-b7 : [32, 48, 80, 160, 224, 384, 640]
        '''
...
class EfficientNetMMdet(nn.Module):
    """
    An EfficientNet model. Most easily loaded with the .from_name or .from_pretrained methods
    Args:
        blocks_args (list): A list of BlockArgs to construct blocks
    ...
    def __init__(self,  model_name = 'efficientnet-b3',
                        ...
                        frozen_stem=True,
                        pretrained=True ):
        super(EfficientNetMMdet, self).__init__()
    ...
    def forward(self, inputs):
        ...
        outs = []
        for out_indice in self.out_indices:
            outs.append(P[out_indice])
        return tuple(outs)
